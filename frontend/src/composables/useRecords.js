...
import { loadRecords, addRecord, deleteRecord as deleteRecordManager, updateRecord as updateRecordManager } from '../utils/recordManager';
import { calculateBatterStats, calculatePitcherStats } from '../utils/statsCalculator';
...
export function useRecords() {
    ...
    const pitcherSummary = computed(() => calculatePitcherStats(allRecords.value));
